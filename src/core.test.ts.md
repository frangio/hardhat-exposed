...
> Snapshot 6
    ...
    ␊
    contract $HasPayableCtor is HasPayableCtor {␊
        bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";␊
    ␊
        constructor() payable {␊
        }␊
    ...
    ␊
    contract $HasPayableCtorParent is HasPayableCtorParent {␊
        bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";␊
    ␊
        constructor() payable {␊
        }␊
...
> Snapshot 1
    ...
    contract $AU is AU {␊
        bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";␊
    ␊
        constructor(uint256 a) initializer {␊
            __A_init(a);␊
        }␊
    ␊
        function $$a() external view returns (uint256) {␊
    ...
    contract $BU is BU {␊
        bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";␊
    ␊
        constructor(uint256 b) initializer {␊
            __B_init(b);␊
        }␊
    ␊
        function $$a() external view returns (uint256) {␊
