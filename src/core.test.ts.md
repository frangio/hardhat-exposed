...
> Snapshot 2
    ...
    ␊
        event $someOverriden_uint256_Returned(bool arg0);␊
    ␊
        event $someOverriden_bytes32_Returned(bool arg0);␊
    ␊
        constructor() {}␊
    ␊
    ...
    ␊
        function $someOverriden(uint256 arg0) external returns (bool) {␊
            (bool ret0) = super.someOverriden(arg0);␊
            emit $someOverriden_uint256_Returned(ret0);␊
            return (ret0);␊
        }␊
    ␊
        function $someOverriden(bytes32 arg0) external returns (bool) {␊
            (bool ret0) = super.someOverriden(arg0);␊
            emit $someOverriden_bytes32_Returned(ret0);␊
            return (ret0);␊
        }␊
    }␊
    `
